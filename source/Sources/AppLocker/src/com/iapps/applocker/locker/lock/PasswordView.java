...
public class PasswordView extends ViewGroup implements OnClickListener,
	...
	public PasswordView(Context context, AttributeSet attrs) {
		...
		/*
		 * If this is true, all children will be square, so the height of this
		 * view will be {@link #mChildHeight} * {@link #mRows} and the width
		 * will be {@link #mChildWidth} * {@link #mCols}<br> This invalidates
		 * {@link #mMaxHScale} and {@link #mMaxVScale} <br> This only works when
		 * {@link #mVerticalSpacing} and {@link #mHorizontalSpacing} are the
		 * same.
		 */
